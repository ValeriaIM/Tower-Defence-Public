...
namespace Tower_Defence
{
    class Program
    {
        ...
        private void DisplayCommandList()
        {
            ...
            Console.WriteLine("P.S. Чтобы переместить башню, необходимо сначала удалить, а потом построить новую.");
            Console.WriteLine("Вы не потеряете очков во время редактирования, но на следующем уровне у вас уже не будет этих башен.");
